 ...
 *
 * <p>{@literal Minecraft 1.20.2 through 1.20.4}. One copy of this class exists per line, under {@code src/mc*}, and the
...
public final class Compat {
    ...
    public static void connect(Screen parent, String address, String name) {
        ConnectScreen.startConnecting(parent, Minecraft.getInstance(),
                ...
                new ServerData(name, address, ServerData.Type.LAN), false);
    }
}
